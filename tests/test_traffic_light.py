...
class TestTrafficLight(unittest.TestCase):
    ...
    def test_traffic_cycle_normal(self):
        ...
        for i in range(4):
            ...
            self.junction._arms[i]._lanes[1]._vehicles.append(Car(0, i, 0, 50, 4))
        ...
        self.junction.simulate(10, 10)
        self.assertEqual(self.junction._traffic_light._traffic_light_dir, 2)
        #After 25s, change to 3
        self.junction.simulate(25000, 10)
        self.assertEqual(self.junction._traffic_light._traffic_light_dir, 3)
    ...
    def test_traffic_light_cycle_double_non_adj_skip(self):
        ...
        for i in range(2):
            ...
            self.junction._arms[2*i]._lanes[1]._vehicles.append(Car(0, 2*i, 0, 50, 4))
        self.assertEqual(self.junction._traffic_light._traffic_light_dir, 0)
    ...
    def test_traffic_light_cycle_triple_skip(self):
        ...
        #Add a car to arm 0
        self.junction._arms[0]._lanes[1]._vehicles.append(Car(0, 0, 0, 50, 4))
        self.assertEqual(self.junction._traffic_light._traffic_light_dir, 0)
    ...
    def test_traffic_light_cycle_empty(self):
        ...
        for i in range(100):
            ...
            self.junction.simulate(self.junction._random.uniform(10, 1000), 10)
            self.assertEqual(self.junction._traffic_light._traffic_light_dir, -1)
...
class TestPedestrianCrossing(unittest.TestCase):
    ...
    def test_empty_junction(self):
        ...
        self.t._p_crossing_interval_time_ms = 0
        #Simulate 1 ms
        self.junction.simulate(1, 1)
        ...
        self.assertEqual(self.t._p_crossing_timer_ms, 10000)
        #Simulate 15s
        ...
        self.assertFalse(self.t._p_crossing_queued)
        self.assertEqual(self.t._traffic_light_dir, -1)
        self.assertLessEqual(self.t._p_crossing_timer_ms, 0)
        self.assertEqual(self.t._traffic_light_gap_timer_ms, 5000)
    ...
    def test_start_empty_junction(self):
        ...
        #Create a car
        self.junction._arms[0]._lanes[1]._vehicles.append(Car(0, 0, 2, 50, 4))
        #Check that 0.5s later the pedestrian crossing is still normal
        self.junction.simulate(500, 100)
        self.assertEqual(self.t._traffic_light_dir, -1)
        self.assertEqual(self.t._p_crossing_timer_ms, 2000)
